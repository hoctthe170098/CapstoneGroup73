...
namespace StudyFlow.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250414105757_Lan28MigrationThemThuocTinhTraLoiVaThemBangNhanXetDinhKy")]
    partial class Lan28MigrationThemThuocTinhTraLoiVaThemBangNhanXetDinhKy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyFlow.Domain.Entities.BaiTap", b =>
                {
                    ...
                    b.HasIndex("NgayTao", "LichHocId")
                        .IsUnique();

                    b.ToTable("BaiTap", (string)null);

                    b.HasAnnotation("CheckConstraint:CK_BaiTap_TrangThai", "[TrangThai] IN ('Chưa mở', 'Đang mở', 'Kết Thúc')");
                });
            ...
            modelBuilder.Entity("StudyFlow.Domain.Entities.NhanXetDinhKy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateOnly>("NgayNhanXet")
                        .HasColumnType("date");
                    ...
                    b.ToTable("NhanXetDinhKy", (string)null);
                });
