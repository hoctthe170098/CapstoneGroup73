...
public class HocSinhs : EndpointGroupBase
{
    public override void Map(WebApplication app)
    {
        app.MapGroup(this)
            ...
            .MapPost(GetHocSinhsByNameOrCode, "gethocsinhbycodeorname")
    ...
    [Authorize(Roles = Roles.CampusManager)]
    public async Task<Output> GetHocSinhsByNameOrCode(ISender sender, GetHocSinhsByNameOrCodeQuery query)
    {
        return await sender.Send(query);
    }
    [Authorize(Roles = Roles.CampusManager)]
