...
using StudyFlow.Application.DiemDanhs.Queries.GetBaoCaoDiemDanh;
using StudyFlow.Domain.Entities;

namespace StudyFlow.Application.Cosos.Queries.GetBaoCaoDiemDanh;
public record GetBaoCaoDiemDanhQuery : IRequest<Output>
{
    public required string TenLop { get; set; }
}
public class GetBaoCaoDiemDanhQueryHandler : IRequestHandler<GetBaoCaoDiemDanhQuery, Output>
{
    ...
    public GetBaoCaoDiemDanhQueryHandler(IApplicationDbContext context
    ...
    public async Task<Output> Handle(GetBaoCaoDiemDanhQuery request, CancellationToken cancellationToken)
    {
        ...
        foreach(var ngay in NgayDaHoc)
        {
            ...
            foreach(var hs in ListHocSinh)
            {
                ...
                else item.TrangThai = diemDanh.TrangThai;
                diemDanhs.Add(item);
            }
